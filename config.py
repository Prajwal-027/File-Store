...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/How_To_Download_Files_XP") # how to open link 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://bottom-aurore-prajwalpatil-a4baef70.koyeb.app/")
